...
class CustomerProfile(models.Model):
    ...
    home_latitude = models.FloatField(null=True, blank=True, validators=latitude_validators)
    home_longitude = models.FloatField(null=True, blank=True, validators=longitude_validators)
    ...
    def __str__(self):
        return f"Customer({self.display_name or self.user})"
...
class Vehicle(models.Model):
    ...
    photo = models.ImageField(
        upload_to="vehicles/", blank=True, null=True, validators=[validate_image_size]
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
